      ...
      <div className="max-w-[1320px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-body-muted leading-[1.7] mb-4 text-[15.5px]">
            ...
            <strong className="text-ink">Maa Kali Hardware</strong> has grown to
            become one of the best hardware shops in the Kathmandu Valley,
          ...
          <p className="text-body-muted leading-[1.7] mb-7 text-[15.5px]">
            ...
            extensive range of products including plumbing supplies, electrical
            equipment, paints, tools, and all essential construction materials
            in Nepal — backed by honest advice and fair prices.
          </p>
